...
if(isQQ){var url='https://ssl.ui.ptlogin2.qq.com/cgi-bin/login?';query['s_url']=hn.indexOf("buy.qq.com")>-1?'http://buy.qq.com%2Fredirect.html':(/(chong\.qq\.com)/.test(hn)?'http%3A%2F%2Fchong.qq.com%2Fmember%2Flogin_s.shtml':'http://imgcache.qq.com%2Fqqshop%2Fac%2Fportal%2Fredirect.html');}else if(isWG){var url='https://ssl.ui.ptlogin2.qq.com/cgi-bin/login?';query['s_url']='http://member.wanggou.com/userlogin/ptlogin%3Floginfrom%3D21';}else{var url='https://ssl.ui.ptlogin2.paipai.com/cgi-bin/login?';query['s_url']='http://member.paipai.com/cgi-bin/ptlogin%3Floginfrom%3D18';}
...
$pubsub={};var topics={},subUid=0;$pubsub.publish=function(topic,data){if(!topics[topic]){return false;}
setTimeout(function(){var subscribers=topics[topic];for(var i=0,j=subscribers.length;i<j;i++){subscribers[i].callback(data);}},0);return true;};$pubsub.subscribe=function(topic,callback){if(!topics[topic]){topics[topic]=[];}
...
{var shophost_reg1=/.*shop\.paipai\.com.*/;if(shopData.pageId=="HOME_PAGE"&&!shophost_reg1.exec(this.req_host))
...
{var reg=/^auction\d?\.paipai\.com$/gim;if(reg.test(this.req_host)&&typeof(pageMess)=="object")
...
try
{var reg=/^shop\.paipai\.com$/gim;if(reg.test(this.req_host)&&shopData!=null&&typeof(shopData)=="object")
...
window['PP.foot']='1023:20130702:20130711101045';
window['PP.foot.time'] && window['PP.foot.time'].push(new Date());/*  |xGv00|6615573daac21934e846db7ad6f9bf6a */